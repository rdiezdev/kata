...
import kata.ramon.pokeapicooker.domain.exception.InvalidPokemonBaseExperienceException;
import kata.ramon.pokeapicooker.domain.exception.MandatoryPokemonBaseExperienceException;
